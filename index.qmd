        ...
        <div class="card g-col-12 g-col-md-4 p-2 rounded home-page-package-card">
            <div class="card-body d-flex flex-column align-items-center">
                ...
                <p class="card-text d-flex align-items-center gap-2">
                    <a href="/test" class="text-body-secondary text-decoration-none"><i class="bi bi-github me-1"></i>Github</a>
                    <a href="/test" class="text-body-secondary text-decoration-none"><i class="bi bi-globe me-1"></i>Website</a>
                </p>
            </div>
        </div>
        <div class="card g-col-12 g-col-md-4 p-2 rounded home-page-package-card">
