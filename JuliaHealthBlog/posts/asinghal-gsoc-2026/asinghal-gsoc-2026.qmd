...
![Two bar charts side by side. Left chart: CPU precompilation benchmark, comparing v0.0.6 (before) and v0.0.7 (after) average times in seconds for each of the 10 benchmarked functions. Right chart: GPU precompilation benchmark, comparing v0.0.9 (before) and v0.0.10 (after). Both charts: x-axis = function name (Scanner, brain_phantom2D, EPI_example, discretize, simulate, Phantom, write_phantom, read_phantom, ...), y-axis = time in seconds, two grouped bars per function.](benchmarks_figure.png)
