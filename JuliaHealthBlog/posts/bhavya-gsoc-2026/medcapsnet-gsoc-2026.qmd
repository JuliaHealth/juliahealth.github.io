...
![The original study's summary of findings across all four datasets (TUPAC16, DIARETDB1, Fashion-MNIST, MNIST): mean F1-scores under decreasing training data, class imbalance, and data augmentation. Reproduced from the reference TensorFlow implementation by Jiménez-Sánchez, Albarqouni & Mateus (MIT License).](reference-summary.png)
