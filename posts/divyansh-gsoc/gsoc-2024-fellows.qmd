...
```
In the above function the keymaps for controlling windowing in MRI and PET modalities are F1, F2, F3, F4, F5, F6 and F7 keys. In windowing, we have a min and a max value that contributes towards the final range of pixels that are displayed. In order to contrast 
...
(a) [https://github.com/JuliaHealth/MedEye3d.jl/pull/20](https://github.com/JuliaHealth/MedEye3d.jl/pull/21)
...
3. Achived supervoxel display in single image display mode.
...
I would like to thank my mentor Dr.Jakub Mitura, for his help throught every phase of this project. The troubleshooting routines around problems would have rendered the project unsuccessful, if not for the support and guidance of my mentor throughout each part of this project. I would also like to thank Jacob Zelko, for weaving Juliahealth community with such vast expertise and leading efforts for engagement amongst the members through monthly meetings. My sincere gratitude towards your support, help and guidance throught the fellowship.
