...
> If you want to know more about me, you can connect with me on [**LinkedIn**](https://www.linkedin.com/in/jay-landge-589439260/) and follow me on [**GitHub**](https://github.com/Jay-sanjay)
...
So to address these challenges we wanna introduce to a set of tools to extract and analyze these patient pathways. These sets of tools are based on the Observational Medical Outcomes Partnership (OMOP) common data model, which standardizes healthcare data to promote interoperability.
...
New documentation using DocumenterVitepress: ![](./img2.png)
